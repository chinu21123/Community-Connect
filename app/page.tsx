...
const translations = {
  en: {
    ...
    loginSuccess: "Welcome! Redirecting to your dashboard...",
    ...
    welcomeMessage: "Welcome to the future of rural digital empowerment",
    platformBy: "Platform by Chelsea Sharma",
  },
  hi: {
    title: "गांव साथी में स्वागत है",
    ...
    loginSuccess: "स्वागत है! आपके डैशबोर्ड पर रीडायरेक्ट हो रहा है...",
    ...
    welcomeMessage: "ग्रामीण डिजिटल सशक्तिकरण के भविष्य में आपका स्वागत है",
    platformBy: "प्लेटफॉर्म चेल्सी शर्मा द्वारा",
  },
  mr: {
    title: "गांव साथी में पधारो",
    subtitle: "आपका डिजिटल गांव द्वार आपका इंतजार कर रहा है",
    ...
    exploreAsGuest: "अतिथि के रूप में देखो",
    loginSuccess: "स्वागत है! आपके डैशबोर्ड पर जा रहे हैं...",
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.contact === "8091778384" && formData.password === "admin123") {
        setSuccess(true)
        setTimeout(() => {
          router.push("/home")
        }, 2000)
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md space-y-6">
          ...
          {/* Welcome Message */}
          <div className="text-center">
            <p className="text-green-700 font-medium text-lg">{t.welcomeMessage}</p>
          </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center pt-2">
                <Button
                  ...
                  variant="outline"
                  className="w-full border-green-300 text-green-700 hover:bg-green-50 hover:border-green-400 transform hover:scale-105 transition-all duration-200 bg-transparent"
                >
          ...
          {/* Platform Credit */}
          <div className="text-center text-xs text-green-600 opacity-75">
            <p>{t.platformBy}</p>
            <p>chelsea.sharma2311@gmail.com | +91 8091778384</p>
          </div>
        </div>
      </div>
